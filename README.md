...
| ...                  | ...                                                                                                                                               | ...                                                                                         | ...        |
| Bit Manipulation     | [Counting Bits](https://leetcode.com/problems/counting-bits/)                                                                                     | [BitCounter.java](src/bit_manipulation/BitCounter.java)                                     | Medium     |
| Bit Manipulation     | [Single Number](https://leetcode.com/problems/single-number/)                                                                                     | [UniqueNumberFinder.java](src/bit_manipulation/UniqueNumberFinder.java)                     | Medium     |
